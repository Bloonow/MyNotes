...
| -------- | -------------------- | ------------------------- | ------------ | ------------------------ | ---------- |
| 1.0      | 特斯拉（Tesla）      |                           |              | GeForce 8/200/300系列    |            |
| 2.0      | 费米（Fermi）        |                           |              | GeForce 400/500系列      |            |
| 3.0      | 开普勒（Kepler）     | Tesla K系列               | Quadro K系列 | GeForce 600/700/800M系列 | Tegra K1   |
| 5.0      | 麦克斯韦（Maxwell）  | Tesla M系列               | Quadro M系列 | GeForce 900系列          | Tegra X1   |
| 6.0      | 帕斯卡（Pascal）     | Tesla P系列               | Quadro P系列 | GeForce 10系列           | Tegra X2   |
| 7.0      | 伏特（Volta）        | Tesla V系列               |              |                          | AGX Xavier |
| 7.5      | 图灵（Turning）      | Tesla T系列               | Quadro T系列 | GeForce 16/20系列        |            |
| 8.0      | 安培（Ampere）       | Tesla A系列               |              | GeForce 30系列           | AGX Orin   |
| 8.9      | 艾达（Ada·Lovelace） | Tesla L系列               |              | GeForce 40系列           |            |
| 9.0      | Hopper               | Tesla H系列（H100、H200） |              |                          |            |
| 10.x     | Blackwell            | Tesla B系列（B40）        |              | GeForce 50系列           |            |
